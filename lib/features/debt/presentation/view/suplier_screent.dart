...
import 'package:ccount/features/debt/presentation/controllers/suplier_controller.dart';
...
import 'package:ccount/core/shared/dialog_create_report.dart';
import 'package:ccount/core/shared/dialog_report_supliers.dart';
import 'package:ccount/features/debt/data/models/customer_model.dart';
import 'package:ccount/features/debt/presentation/client/view/add_new_client_screen.dart';
import 'package:ccount/features/debt/presentation/client/view/page_client_transaction.dart';
import 'package:ccount/features/debt/presentation/client/widget/card_client.dart';
...
import 'package:ccount/features/debt/presentation/client/widget/filtter_dialog.dart';
...
class SuplierScreent extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    SuplierController _ctrl = Get.put(SuplierController());

    return Scaffold(
      resizeToAvoidBottomInset: false,
      floatingActionButtonLocation: FloatingActionButtonLocation.startFloat,
      floatingActionButton: GetBuilder<SuplierController>(
        builder: (control) => SizedBox(
          ...
          child: FloatingButton(
            ...
            sizeIcon: 25,
            onTap: () async {
              // control.showDialogeAddsupliers(context, control.boxMod.currncy);

              control.cleareControllers();

              control.initDateTime();

              control.goToAddNewsupliers();
            },
          ),
        ),
      ),
      ...
      body: GetBuilder<SuplierController>(
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: GetBuilder<SuplierController>(
                                ...
                                headerSliverBuilder:
                                  ...
                                  return [
                                                                  ...
                                                                  style: TextStyleTheme
                                                                      .priceStyle(
                                                                          AppColor
                                                                              .plusColor))
                                                              : Text(
                                                                  "${controller.boxMod!.currncyCode} ${chaongToPricFormatter((controller.boxMod!.alihe!.abs()).toString())}",
                                                                  style: TextStyleTheme
                                                                      .priceStyle(
                                                                          AppColor
                                                                              .plusColor),
                                                                  ...
                                                                  style: TextStyleTheme
                                                                      .priceStyle(
                                                                          AppColor
                                                                              .minusColor))
                                                              : Text(
                                                                  "${c.boxMod!.currncyCode} ${chaongToPricFormatter((c.boxMod!.laho!.abs()).toString())}",
                                                                  style: TextStyleTheme
                                                                      .priceStyle(
                                                                          AppColor
                                                                              .minusColor),
                                    ...
                                    SliverAppBar(
                                      ...
                                      automaticallyImplyLeading: false,
                                      title: GetBuilder<SuplierController>(
                                        builder: (_controller) =>
                                            TextFormFieldWidget(
                                          onChanged: (value) {
                                    ...
                                    if (_controller.data.isEmpty) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: _controller
                                            .filtersupliersList.length,
                                        itemBuilder: (context, index) {
                                          return GestureDetector(
                                            onTap: () {
                                              _controller
                                                  .goToPagesupliersTransaction(
                                                      index,
                                                      _controller
                                                              .filtersupliersList[
                                                          index]);
