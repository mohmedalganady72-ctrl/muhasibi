...
class CustomerRepository {
  ...
  Future<void> addCustomerLakom(int id, num lakom) async {
    final db = await DatabaseHelper.instance.database;
    await db.rawUpdate(
      '''
    UPDATE $customerTabl 
  ...
  Future<void> minusCustomerLakom(int id, num lakom) async {
    final db = await DatabaseHelper.instance.database;
    await db.rawUpdate(
      '''
    UPDATE $customerTabl 
  ...
  Future<void> addCustomerAlikom(int id, num alikom) async {
    final db = await DatabaseHelper.instance.database;
    await db.rawUpdate(
      '''
    UPDATE $customerTabl 
  ...
  Future<void> minusCustomerAlikom(int id, num alikom) async {
    final db = await DatabaseHelper.instance.database;
    await db.rawUpdate(
      '''
    UPDATE $customerTabl 
