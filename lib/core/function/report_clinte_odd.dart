...
//     totalAlikom = totalAlikom + item.payables!;
//     totalLakom = totalLakom + item.receivables!;
//     return [
//       chaongToPricFormatter(
//           ((item.payables ?? 0) - (item.receivables ?? 0)).toString()),
//       chaongToPricFormatter((item.receivables ?? 0).abs().toString()),
//       chaongToPricFormatter((item.payables ?? 0).abs().toString()),
//       "${item.phone ?? ""}",
//       "${item.name ?? ""}"
//     ];
//   }).toList();
...
//                     child: pw.Text(
//                         "${chaongToPricFormatter((totalAlikom - totalLakom).toString())}",
//                         textDirection: pw.TextDirection.rtl,
//                         style: headerTextStyle)),
//                 pw.Container(
//                     padding: pw.EdgeInsets.all(8),
