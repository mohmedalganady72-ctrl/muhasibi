...
class DialogReportSupliers extends StatelessWidget {
  List<CustomerModel>? dataClient;
  String? currncyName;

  DialogReportSupliers({super.key, this.dataClient, this.currncyName});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: RowFieldIcon(
                    ...
                    // horizontalPadding: 0,
                    // verticalPadding: 0,
                    childField: GetBuilder<SuplierController>(
                      ...
                      builder: (controller) => GestureDetector(
                        ...
                        child: AbsorbPointer(
                          child: DataField(
                            ...
                            // initialValue: "${controller.supliersDate}"
                            //     "${controller.supliersTime}",
                            // readOnly: true,
      ...
      actions: [
        GetBuilder<SuplierController>(
            builder: (_controll) => AbsorbPointer(
