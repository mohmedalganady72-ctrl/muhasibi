...
class DialogCreateReportTransaction extends StatelessWidget {
  // String? initVal;
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: RowFieldIcon(
                    ...
                    // horizontalPadding: 0,
                    // verticalPadding: 0,
                    childField: GetBuilder<TransactionControlle>(
      ...
      actions: [
        GetBuilder<TransactionControlle>(
            builder: (controll) => AbsorbPointer(
                  absorbing: !controll.stateReport,
                  child: GestureDetector(
                    onTap: () async {
                      await controll.exportPdf(context, controll.rows,
                          controll.rows.first.currencyCode!);
                    },
                    child: Container(
                        height: 40.h,
